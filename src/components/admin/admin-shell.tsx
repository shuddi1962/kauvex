...
function detectSection(pathname: string): SectionKey {
  ...
  if (pathname.startsWith("/admin/delivery") || pathname.startsWith("/admin/drivers") || pathname.startsWith("/admin/returns") || pathname.startsWith("/admin/shipping") || pathname.startsWith("/admin/shipping-carriers") || pathname.startsWith("/admin/shipping/hs-codes") || pathname.startsWith("/admin/shipping/restrictions") || pathname.startsWith("/admin/shipping/surge-pricing") || pathname.startsWith("/admin/shipping/business-accounts") || pathname.startsWith("/admin/logistics") || pathname.startsWith("/admin/logistics/global") || pathname.startsWith("/admin/logistics/countries") || pathname.startsWith("/admin/logistics/carriers") || pathname.startsWith("/admin/logistics/ioss") || pathname.startsWith("/admin/logistics/ddp") || pathname.startsWith("/admin/logistics/compliance") || pathname.startsWith("/admin/packaging") || pathname.startsWith("/admin/locations") || pathname.startsWith("/admin/warehouses") || pathname.startsWith("/admin/pickup-points") || pathname.startsWith("/admin/dropoff-zones") || pathname.startsWith("/admin/warranty") || pathname.startsWith("/admin/field-team") || pathname.startsWith("/admin/cj-dropshipping") || pathname.startsWith("/admin/forecasting") || pathname.startsWith("/admin/fraud")) return "operations";
