  ...
  },
  {
    ...
    groups: [
      ...
      { title: "Vendors", items: [
        ...
        { label: "Commission Rates", href: "/admin/commission-rates", badge: "New" },
...
function detectSection(pathname: string): SectionKey {
  ...
  if (pathname.startsWith("/admin/homepage") || pathname.startsWith("/admin/page-editor") || pathname.startsWith("/admin/menu") || pathname.startsWith("/admin/footer") || pathname.startsWith("/admin/media") || pathname.startsWith("/admin/pages") || pathname.startsWith("/admin/blog")) return "content";
