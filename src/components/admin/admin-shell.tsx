...
function detectSection(pathname: string): SectionKey {
  ...
  if (pathname.startsWith("/admin/storefronts") || pathname.startsWith("/admin/vendors") || pathname.startsWith("/admin/vendor-ads") || pathname.startsWith("/admin/fbk") || pathname.startsWith("/admin/boat-configurator") || pathname.startsWith("/admin/reputation") || pathname.startsWith("/admin/authenticity") || pathname.startsWith("/admin/suppliers") || pathname.startsWith("/admin/franchise") || pathname.startsWith("/admin/auctions") || pathname.startsWith("/admin/sourcing") || pathname.startsWith("/admin/pod") || pathname.startsWith("/admin/art-marketplace") || pathname.startsWith("/admin/group-buy") || pathname.startsWith("/admin/nft")) return "marketplace";
