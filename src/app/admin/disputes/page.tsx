...
const sidebarSections = [
  ...
  },
  {
    title: "Operations",
    items: [
      { label: "Disputes", icon: Shield, href: "/admin/disputes", active: true },
        ...
        <header className="bg-white border-b border-gray-200 h-[60px] flex items-center justify-between px-4 lg:px-6 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <h1 className="font-bold text-lg text-text-1">Disputes</h1>
              <p className="text-[11px] text-text-4 -mt-0.5">Manage buyer protection cases</p>
            </div>
          </div>
