...
import {
  ...
  Route, DollarSign, Landmark, Briefcase, ShieldAlert, Globe2,
  Gamepad2,
} from "lucide-react";
  ...
  },
  {
    ...
    groups: [
      ...
      { title: "Finance", items: [
        ...
        { label: "Pay Later Agreements", href: "/admin/pay-later" },
  ...
  },
  {
    ...
    groups: [
      ...
      { title: "Gamification", items: [
        { label: "Rewards Dashboard", href: "/admin/gamification", badge: "New" },
        { label: "Spin Wheel", href: "/admin/gamification/spin-wheel", badge: "P26" },
        { label: "Achievements", href: "/admin/gamification/achievements", badge: "P26" },
        { label: "Referral Milestones", href: "/admin/gamification/milestones", badge: "P26" },
      ]},
    ],
  },
  {
  ...
  },
  {
    ...
    groups: [
      ...
      { title: "Partner Network", items: [
        ...
        { label: "Manufacturers", href: "/admin/manufacturers", badge: "P24" },
        { label: "Manufacturer Hubs", href: "/admin/manufacturers/hubs", badge: "P24" },
        { label: "Manufacturer Disputes", href: "/admin/manufacturers/disputes", badge: "P24" },
        { label: "Wholesale Accounts", href: "/admin/wholesale", badge: "New" },
      ...
      { title: "Sourcing & Products", items: [
        ...
        { label: "Kauvex Originals", href: "/admin/originals", badge: "P24" },
        { label: "Print on Demand", href: "/admin/pod", badge: "New" },
        { label: "Art Marketplace", href: "/admin/art-marketplace", badge: "New" },
        { label: "NFT Marketplace", href: "/admin/nft", badge: "New" },
        { label: "Dropshipping", href: "/admin/cj-dropshipping" },
        { label: "Restricted Categories", href: "/admin/catalog/restricted-categories", badge: "New" },
        { label: "Approval Requests", href: "/admin/catalog/approval-requests", badge: "New" },
        { label: "Brand Registry", href: "/admin/brand-registry", badge: "New" },
        { label: "Seller University", href: "/admin/university", badge: "New" },
      ]},
  ...
  },
  {
    ...
    groups: [
      { title: "Logistics", items: [
        { label: "Logistics Dashboard", href: "/admin/logistics" },
        { label: "Global Overview", href: "/admin/logistics/global", badge: "New" },
        { label: "Country Management", href: "/admin/logistics/countries", badge: "New" },
        { label: "Command Center", href: "/admin/command-center", badge: "P20" },
        { label: "Live Logistics Map", href: "/admin/logistics/live", badge: "P20" },
        { label: "Express Management", href: "/admin/express", badge: "P20" },
        { label: "Locker Management", href: "/admin/lockers", badge: "P20" },
        ...
        { label: "Partners", href: "/admin/logistics/partners" },
        { label: "Rate Cards", href: "/admin/logistics/rates" },
        { label: "Dispatch Settings", href: "/admin/logistics/dispatch" },
        { label: "Insurance & Liability", href: "/admin/logistics/insurance" },
        { label: "Payouts", href: "/admin/logistics/payouts" },
        { label: "Fuel Stations", href: "/admin/logistics/fuel", badge: "P20" },
        { label: "FBK Oversight", href: "/admin/logistics/fbk" },
        ...
        { label: "Customs Documents", href: "/admin/shipping/customs-documents", badge: "New" },
        { label: "Restricted Items", href: "/admin/shipping/restrictions" },
        { label: "Virtual Addresses", href: "/admin/logistics/virtual-addresses", badge: "New" },
        ...
        { label: "Carrier Integrations", href: "/admin/logistics/carriers", badge: "New" },
        { label: "IOSS Automation", href: "/admin/logistics/ioss", badge: "New" },
        { label: "DDP Compliance", href: "/admin/logistics/ddp", badge: "New" },
        { label: "Compliance Dashboard", href: "/admin/logistics/compliance", badge: "New" },
      ]},
      { title: "Fuel Management", items: [
        { label: "Fuel Dashboard", href: "/admin/fuel", badge: "P20" },
        { label: "Fuel Prices", href: "/admin/fuel/prices", badge: "P20" },
        { label: "Surcharge Rules", href: "/admin/fuel/surcharge-rules", badge: "P20" },
        { label: "Cost Analysis", href: "/admin/fuel/cost-analysis", badge: "P20" },
      ]},
      { title: "Warehouse", items: [
        { label: "Locations", href: "/admin/locations" },
        { label: "All Warehouses", href: "/admin/logistics/warehouses" },
        { label: "Warehouse Overview", href: "/admin/warehouses/overview", badge: "P20" },
        { label: "Live Warehouse Map", href: "/admin/warehouses/live", badge: "P20" },
      ...
      { title: "Intelligence", items: [
        { label: "Analytics Intelligence", href: "/admin/analytics/intelligence", badge: "P20" },
      ]},
  ...
  },
  {
    ...
    groups: [
      ...
      { title: "Security", items: [
        { label: "Firewall & WAF", href: "/admin/security/firewall", badge: "P25" },
        { label: "Error Monitoring", href: "/admin/security/monitoring", badge: "P25" },
        { label: "Identity Review", href: "/admin/security/identity-review", badge: "P25" },
        { label: "Fraud Detection", href: "/admin/security/fraud", badge: "P25" },
...
function detectSection(pathname: string): SectionKey {
  ...
  if (pathname.startsWith("/admin/pos") || pathname.startsWith("/admin/finance") || pathname.startsWith("/admin/bnpl") || pathname.startsWith("/admin/pay-later") || pathname.startsWith("/admin/wallets") || pathname.startsWith("/admin/financing") || pathname.startsWith("/admin/insurance") || pathname.startsWith("/admin/credit")) return "sales";
  if (pathname.startsWith("/admin/marketing") || pathname.startsWith("/admin/email-marketing") || pathname.startsWith("/admin/advertising") || pathname.startsWith("/admin/banners") || pathname.startsWith("/admin/popups") || pathname.startsWith("/admin/seo") || pathname.startsWith("/admin/affiliates") || pathname.startsWith("/admin/social-commerce") || pathname.startsWith("/admin/live-shopping") || pathname.startsWith("/admin/gamification")) return "marketing";
  ...
  if (pathname.startsWith("/admin/storefronts") || pathname.startsWith("/admin/vendors") || pathname.startsWith("/admin/vendor-ads") || pathname.startsWith("/admin/fbk") || pathname.startsWith("/admin/boat-configurator") || pathname.startsWith("/admin/reputation") || pathname.startsWith("/admin/authenticity") || pathname.startsWith("/admin/suppliers") || pathname.startsWith("/admin/manufacturers") || pathname.startsWith("/admin/wholesale") || pathname.startsWith("/admin/franchise") || pathname.startsWith("/admin/auctions") || pathname.startsWith("/admin/sourcing") || pathname.startsWith("/admin/pod") || pathname.startsWith("/admin/art-marketplace") || pathname.startsWith("/admin/group-buy") || pathname.startsWith("/admin/nft") || pathname.startsWith("/admin/catalog") || pathname.startsWith("/admin/brand-registry") || pathname.startsWith("/admin/university")) return "marketplace";
