...
import { successResponse, errorResponse, paginatedResponse, getAuthUser, requireAdmin, validateBody } from "@/lib/api-helpers";
import { z } from "zod";
  ...
  try {
    ...
    if (authHeader?.startsWith("Bearer ")) {
      ...
      if (user) {
        ...
        return paginatedResponse(coursesWithProgress, total, page, limit);
      }
    }
