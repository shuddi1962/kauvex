...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const isDashboard = pathname.startsWith("/admin") || pathname.startsWith("/vendor") || pathname.startsWith("/account") || pathname.startsWith("/auth") || pathname.startsWith("/warehouse") || pathname.startsWith("/express") || pathname.startsWith("/logistics");
